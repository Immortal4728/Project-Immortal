    ...
    return (
        <main className="min-h-screen bg-black text-white px-6 md:px-12 py-24">
          ...
          prose-a:no-underline hover:prose-a:underline">
                    ...
                    {/* ✅ PASTE YOUR ENTIRE PRIVACY POLICY HTML HERE */}
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to project immortal.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to project immortal, accessible from <a href="www.project-immortal.com" target="_blank">www.project-immortal.com</a>.</p>
                        </li>
                        <li>
                    ...
                    {/* 👉 paste remaining content below exactly */}
