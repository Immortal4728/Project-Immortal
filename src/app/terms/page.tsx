        ...
        <main className="min-h-screen bg-black text-white px-6 md:px-12 py-24">
          ...
          prose-a:no-underline hover:prose-a:underline"
                >
                    ...
                    {/* ✅ PASTE YOUR FULL TERMS & CONDITIONS HTML HERE */}
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to project immortal.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to project immortal, accessible from <a href="www.project-immortal.com" rel="external nofollow noopener" target="_blank">www.project-immortal.com</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: rishichowdary2099@gmail.com</li>
                    </ul>

                </article>

                {/* FOOTER NOTE */}
                <div className="mt-20 pt-10 border-t border-white/10 text-white/50 text-sm">
                    © Project Immortal — Rishi Chowdary
                </div>
