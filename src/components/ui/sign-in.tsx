...
export const SignInPage: React.FC<SignInPageProps> = ({
    ...
    return (
        <div className="h-[100dvh] flex flex-col md:flex-row font-geist w-[100dvw]">
                        ...
                        <form className="space-y-5" onSubmit={onSignIn}>
                            ...
                            {showOrderId && (
                                <div className="animate-element animate-delay-450">
                                    ...
                                    <GlassInputWrapper>
                                        <input name="orderId" type="text" placeholder="e.g. IMM-48392011" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none tracking-wider" />
                                    </GlassInputWrapper>
                                </div>
                            )}
            ...
            {heroImageSrc && (
                <section className="hidden md:block w-[40%] relative p-4">
